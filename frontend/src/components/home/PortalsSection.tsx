                        ...
                        return (
                            ...
                            >
                                <Link to={portal.path} className="block h-full">
                                    <div className="group bg-gray-800 rounded-2xl p-6 hover:bg-gray-700 transition-all cursor-pointer h-full border border-gray-700 hover:border-gray-600 flex flex-col">
                                        <div
                                        ...
                                        <p className="text-gray-400 mb-4 flex-grow">{portal.description}</p>
                                        <div
