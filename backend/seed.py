...
from apps.core.models import (
    School, Learner, Artifact, Module, Assessment, 
    PathwayInputs, GateSnapshot, Credential, WeeklyPulse
)
...
def run():
    ...
    school, _ = School.objects.get_or_create(
        name="Fundi Bots Academy",
        defaults={"code": "FBA-001"}
    )
        ...
        if not User.objects.filter(username=username).exists():
            ...
            for i in range(random.randint(2, 5)):
                ...
                Artifact.objects.create(
                    ...
                    media_refs=[{"type": "image", "url": "https://placehold.co/600x400"}]
                )
