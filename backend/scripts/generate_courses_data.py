...
if created:
    ...
    levels = [
        {
            "name": "Curiosity",
            "description": "Discovering robots and how they work",
            "learning_outcomes": [
                "Identify robot parts",
                "Understand basic sensors",
        ...
        {
            "name": "Builder",
            "description": "Programming basic movements",
            "learning_outcomes": [
                "Write simple programs",
                "Make robot move forward/backward",
                "Use sensors",
            ],
        },
        {
            "name": "Creator",
            "description": "Design your own robot project",
            "learning_outcomes": [
                "Design a robot solution",
                "Present your work",
...
if created:
    ...
    levels = [
        {
            "name": "Foundations",
            "description": "Review basics and introduce advanced concepts",
            "learning_outcomes": [
                "Program with loops",
        ...
        {
            "name": "Mechanics",
            "description": "Understanding robot mechanics",
            "learning_outcomes": [
                "Build complex mechanisms",
                "Use gears and levers",
                "Create stable structures",
            ],
        },
        {
            "name": "Automation",
            "description": "Creating autonomous robots",
            "learning_outcomes": [
        ...
        {
            "name": "Innovation",
            "description": "Design and build original robots",
            "learning_outcomes": [
...
if created:
    ...
    levels = [
        {
            "name": "Block Basics",
            "description": "Introduction to block-based coding",
            "learning_outcomes": [
                "Use Scratch",
        ...
        {
            "name": "Logic & Loops",
            "description": "Programming logic fundamentals",
            "learning_outcomes": [
                "Use conditionals",
                "Implement loops",
        ...
        {
            "name": "Text Code Intro",
            "description": "Transition to text-based coding",
            "learning_outcomes": [
                "Write Python basics",
                "Use variables",
        ...
        },
        {
            ...
            "description": "Build a complete coding project",
            "learning_outcomes": [
                "Design a project",
                "Implement features",
                "Test and debug",
...
for learner in Learner.objects.all():
    ...
    eligible_courses = Course.objects.filter(
        is_active=True, min_age__lte=age, max_age__gte=age
    )
    ...
    for course in eligible_courses:
        enrollment, created = LearnerCourseEnrollment.objects.get_or_create(
            learner=learner,
            course=course,
            defaults={"current_level": course.levels.order_by("level_number").first()},
        )
